...
const columns: GridColDef[] = [
  ...
  {
    field: "action", headerName: "Action", width: 300, sortable: false, align: 'center', headerAlign: 'center', renderCell: (params) => {
...
function ManageUser() {
  ...
  const newRows = dataRetrieve.data ? dataRetrieve.data : [];
